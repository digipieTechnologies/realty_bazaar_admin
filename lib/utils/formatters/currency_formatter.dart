...
final currencyFormatter = CurrencyTextInputFormatter.currency(symbol: "", locale: "en_IN", decimalDigits: 2);
...
class CurrencyTextInputFormatter extends TextInputFormatter {
  ...
  factory CurrencyTextInputFormatter(
    ...
    return CurrencyTextInputFormatter._(format, enableNegative, inputDirection, minValue, maxValue, onChange);
  }
  ...
  String formatDouble(double value) {
    ...
    final String newText = value.toStringAsFixed(format.decimalDigits ?? 0).replaceAll(RegExp('[^0-9]'), '');
    _formatter(newText);
    return _newString;
  }

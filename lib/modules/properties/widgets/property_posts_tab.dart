...
class PropertyPostsTab extends StatefulWidget {
  final String? propertyId;

  const PropertyPostsTab({super.key, required this.propertyId});

  @override
  State<PropertyPostsTab> createState() => _PropertyPostsTabState();
}

class _PropertyPostsTabState extends State<PropertyPostsTab> with AutomaticKeepAliveClientMixin {
  ...
  void _loadPosts() {
    ...
    if (propertyId != null && propertyId.isNotEmpty) {
      _postsFuture = AdminDataService.instance.getSocialPostsForProperty(propertyId);
    } else {
  ...
  Widget build(BuildContext context) {
    ...
    if (propertyId == null || propertyId.isEmpty) {
      return Column(
        ...
        children: [
          TabHeader(title: 'tab_posts'.tr(), padding: const EdgeInsets.all(16)),
          Expanded(
            child: Center(child: Text('no_posts_available'.tr(), style: context.cardSubtitle)),
          ),
        ],
      );
    }
                    ...
                    return Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text('no_posts_available'.tr(), style: context.cardSubtitle),
                        ],
                      ),
                    );
                  }

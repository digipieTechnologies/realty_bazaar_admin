...
// Purpose: Unified button widget across the application with variants, loading states, and theme tokens.
...
class AppButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (effectivelyDisabled) {
      ...
      switch (variant) {
        ...
        case AppButtonVariant.outline:
          ...
          resolvedTextColor = textColor ?? AppColors.textPrimary;
          break;

        case AppButtonVariant.secondary:
          resolvedBgColor = color ?? AppColors.primary.withOpacity(0.1);
    ...
    if (effectiveIcon == null && iconData != null) {
      effectiveIcon = Icon(iconData, size: (resolvedStyle.fontSize ?? 14.0) + 4.0, color: resolvedTextColor);
    }
    ...
    if (child != null) {
      ...
      bodyContent = Row(
        ...
        children: [
          if (isLoading) ...[
            AppLoader(size: (resolvedStyle.fontSize ?? 14.0) + 4.0, color: resolvedTextColor),

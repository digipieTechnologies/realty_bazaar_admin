// File: lib/modules/properties/widgets/step_property_details_widget.dart
// Purpose: Step 2 Property Details & Specs form widget for Admin Property Wizard.
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        _buildSectionHeader(
          context,
          title: 'section_media'.tr(),
          dialogTitle: 'section_media'.tr(),
        ...
        _buildSectionHeader(
          ...
          dialogTitle: 'section_basic_info'.tr(),
          dialogDesc:
        ...
        AppTextField(
          ...
          label: '${'property_title_label'.tr()} *',
          hintText: 'property_title_hint'.tr(),
        ...
        AppTextField(
          ...
          label: 'property_desc_label'.tr(),
          hintText: 'property_desc_hint'.tr(),
          maxLines: 3,
        ),
        const SizedBox(height: 14.0),
            ...
            children: [
              Expanded(
                ...
                child: AppTextField(
                  ...
                  label: '${'super_area_label'.tr()} *',
                  hintText: 'area_hint'.tr(),
                  keyboardType: TextInputType.number,
        ...
        _buildSectionHeader(
          context,
          title: 'section_listing_purpose'.tr(),
          dialogTitle: 'section_listing_purpose'.tr(),
          dialogDesc:
        ...
        _buildSectionHeader(
          context,
          title: 'section_room_specs'.tr(),
          dialogTitle: 'section_room_specs'.tr(),
          dialogDesc:
        ...
        if (isMobile) ...[
            ...
            children: [
              ...
              Expanded(
                child: AppTextField(
                  ...
                  label: 'total_floors_label'.tr(),
                  hintText: 'total_floors_hint'.tr(),
                  keyboardType: TextInputType.number,
                ),
              ),
            ],
          ...
          const SizedBox(height: 14.0),
          AppDropdown<String>(
            label: 'facing_label'.tr(),
            hint: 'facing_label'.tr(),
        ...
        _buildSectionHeader(
          context,
          title: 'section_furnishing'.tr(),
          dialogTitle: 'section_furnishing'.tr(),
          dialogDesc:
        ...
        _buildSectionHeader(
          context,
          title: 'section_amenities'.tr(),
          dialogTitle: 'section_amenities'.tr(),
                ...
                children: [
                  Expanded(
                    child: Image.asset(
                      ...
                      errorBuilder: (context, error, stackTrace) => Container(
                        color: AppColors.background,
                        child: const Icon(Icons.chair, color: AppColors.textSecondary),
                      ),
                    ),
                  ),
                  Padding(
              ...
              children: [
                ...
                if (isSelected)
                  const Padding(
                    ...
                    child: Icon(Icons.check_circle_rounded, color: AppColors.primary, size: 20.0),
                  ),
              ],
            ),
          ),

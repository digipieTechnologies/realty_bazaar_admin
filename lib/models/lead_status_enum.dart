...
// Purpose: Type-safe enum representing lead status in the system (pending, active, inactive, converted, noResponse, junk).
  ...
  String get label {
    switch (this) {
      case LeadStatus.pending:
        return 'leads_status_pending'.tr();
      case LeadStatus.active:
        return 'leads_status_active'.tr();
      case LeadStatus.inactive:
        return 'leads_status_inactive'.tr();
      case LeadStatus.converted:
        return 'leads_status_converted'.tr();
      case LeadStatus.noResponse:
        return 'leads_status_no_response'.tr();
      case LeadStatus.junk:
        return 'leads_status_junk'.tr();
    }
  }

// File: lib/widgets/common/app_lead_status_badge.dart
// Purpose: Interactive, theme-aware badge for displaying and quickly changing lead status (active, inactive, junk).
  ...
  Widget build(BuildContext context) {
    ...
    return Theme(
      ...
      child: PopupMenuButton<LeadStatus>(
        tooltip: 'leads_status_change_title'.tr(),
                ...
                Expanded(
                  child: Text(
                    ...
                    style: TextStyle(
                      ...
                      color: isCurrent ? s.color : context.colorScheme.onSurface,
                    ),
                  ),
                ),

...
// Purpose: Structured grid of specifications for property preview.
    ...
    return Container(
      ...
      child: Column(
        children: [
          Row(
            children: [
              _buildSpecItem(label: 'property_spec_bedrooms'.tr(), value: '${property.bedrooms}'),
              _buildSpecItem(
                label: 'property_spec_bathrooms'.tr(),
                value: '${property.bathrooms}',
                crossAxisAlignment: CrossAxisAlignment.center,
              ),
              _buildSpecItem(
                label: 'property_spec_balconies'.tr(),
          ...
          Row(
            children: [
              _buildSpecItem(label: 'property_spec_area'.tr(), value: formattedArea),
              _buildSpecItem(
                label: 'property_spec_facing'.tr(),
                value: PropertyLocalizer.getLocalizedFacing(context, property.facing ?? ''),
                crossAxisAlignment: CrossAxisAlignment.center,
              ),
              _buildSpecItem(
                label: 'property_spec_parking'.tr(),
